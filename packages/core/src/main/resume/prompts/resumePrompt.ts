...
- For the "skills" section, group skills by typology using the "name" field for the group. Create a single "Soft & Management Skills" section that combines both soft skills and management skills, then create multiple "Technical Skills" subsections grouped by the following categories:
  * Architecture & Design
  ...
  * APIs & Protocols
  * AI
  Each technical category should be a separate skill group with the category name as the "name" field and relevant skills in the "keywords" array. List soft and management skills first, then technical skills in the order specified above.
